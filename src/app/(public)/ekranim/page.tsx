...
export const metadata: Metadata = {
  title: "Ekranımı Oku — Togg Sembol Rehberi",
  description:
    "Togg T10X veya T10F ekranındaki uyarı sembolünü arayın — ne anlama geldiğini ve ne yapmanız gerektiğini öğrenin.",
  keywords: [
    "togg ekran mesajı",
...
export default function EkranimSayfasi() {
  return (
      ...
      <div className="mx-auto max-w-2xl px-4 py-10">
        ...
        <div className="mb-8">
          ...
          <p className="mt-2 text-slate-400">
            Kontrol panelinizde gördüğünüz sembolü arayın — Togg el kitabına göre
            ne anlama geldiğini ve ne yapmanız gerektiğini öğrenin.
          </p>
        </div>
        ...
        <div className="mt-10 rounded-2xl border border-white/8 bg-slate-900/40 p-5">
          ...
          <ul className="space-y-2 text-sm text-slate-500">
            <li className="flex items-start gap-2">
              <span>📘</span>
              <span>Sembol açıklamaları Togg T10X ve T10F resmi kullanıcı el kitabı bölüm 6.2.2&apos;ye dayanmaktadır.</span>
            </li>
            <li className="flex items-start gap-2">
              <span>💬</span>
              <span>Bu araç bilgilendirme amaçlıdır. Önemli durumlarda yetkili Togg servisini ziyaret edin.</span>
            </li>
          </ul>
        </div>
      </div>
