...
export default function GirisIstemci() {
      ...
      <div className="w-full max-w-sm">
        ...
        <div className="rounded-2xl border border-white/10 bg-white/5 p-8">
          ...
          <button
            ...
            disabled={yukleniyor}
            className="flex w-full items-center justify-center gap-3 rounded-xl border border-white/20 bg-white px-4 py-3 text-sm font-semibold text-black transition hover:bg-neutral-100 disabled:cursor-not-allowed disabled:opacity-60"
          >
            {yukleniyor ? (
              <svg
