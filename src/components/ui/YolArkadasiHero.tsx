    ...
    >
      ...
      <div className="relative w-full max-w-md space-y-3">
        ...
        <Link
          ...
          aria-label="Ekrandaki uyarı sembolünü öğren"
        >
          ...
          <div className="text-left">
            <p className="text-xl font-bold text-white">Ekranımı Oku</p>
            <p className="text-sm font-medium text-white/70">88 sembol — anında açıklama</p>
          </div>
        </Link>
